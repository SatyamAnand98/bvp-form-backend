...
var BoltServer = /** @class */ (function () {
    function BoltServer() {
        ...
        this.configDBModels = function () { return __awaiter(_this, void 0, void 0, function () {
            var error_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                    ...
                    case 2:
                        error_1 = _a.sent();
                        console.log("\uD83D\uDD34 Mongodb Connection error: ".concat(error_1.message));
                        return [3 /*break*/, 3];
        ...
        this.start = function () {
            _this.server.listen(process.env.PORT || 3001, function () {
                console.log("\uD83D\uDFE2 Server is running on port ".concat(process.env.PORT || 3002));
            });
